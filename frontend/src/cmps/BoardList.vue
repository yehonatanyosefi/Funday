        ...
        <ul class="boards">
            <Container orientation="vertical" @drop="onBoardDrop($event)">
                <Draggable v-for="board in boardList" :key="board._id">
                    <li class="board-link board-title"
                        :class="{ 'selected-board': currBoardId === board._id, 'rename': editedBoardId === board._id && isRename }"
                        ...
                        <div v-if="isModalOpen && editedBoardId === board._id" class="modal"
